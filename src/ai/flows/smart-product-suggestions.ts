...
/**
 * @fileOverview A smart suggestion AI agent for product recommendations.
 *
 * - getSmartSuggestions - A function that retrieves smart suggestions for products based on historical data.
...
const SmartSuggestionOutputSchema = z.array(
  z.object({
