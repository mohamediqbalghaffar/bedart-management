...
export const PrintableReceipt = React.forwardRef<HTMLDivElement, PrintableReceiptProps>(({ formData, products, payments, companyInfo }, ref) => {
    ...
    const hasPayments = formData.paymentType === 'Installments' || (payments && payments.length > 0);
    ...
    return (
        <div ref={ref} id="printable-receipt-content" className="new-receipt-container" dir="rtl">
            ...
            <main className="receipt-body">
                ...
                <div className="form-number-badge">
                    No. {String(formData?.formNumber || '0')}
                </div>
                    ...
                    <div className="totals-summary">
                        ...
                        {hasPayments && (
                            <>
                                ...
                                {overpayment > 0 && (
                                    <div className="summary-line overpaid">
